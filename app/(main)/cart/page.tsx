    ...
    <>
      {isEmpty ? (
        ...
        <div className="relative mt-5 flex h-[calc(100dvh-60px)] flex-col items-center justify-start gap-3">
          ...
          <div className="flex h-[92%] w-[95%] flex-col items-center justify-start gap-3 rounded-2xl bg-secondary px-5 pt-10 md:h-[90%] md:w-[70%] md:justify-center md:bg-background xl:w-[50%]">
            <ScrollArea
              className="max-h-[83%] w-full rounded-2xl md:h-full md:bg-secondary md:p-3"
              dir="rtl"
            >
            ...
            <div className="mt-auto mb-3 flex w-full items-center justify-between gap-1 border-t-3 border-muted p-3 md:mt-0 md:mb-0 md:rounded-2xl md:border-0 md:bg-secondary">
